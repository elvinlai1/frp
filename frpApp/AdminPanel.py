...
class Ui_AdminPanel(object):
    def setupUi(self, AdminPanel):
        ...
        self.btnRegister.setGeometry(QtCore.QRect(10, 210, 351, 26))
        self.btnRegister.setObjectName("btnRegister")
        self.statusTxtBox = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.statusTxtBox.setGeometry(QtCore.QRect(10, 250, 351, 81))
        ...
        self.empNumLbl.setGeometry(QtCore.QRect(20, 170, 144, 21))
        self.empNumLbl.setObjectName("empNumLbl")
        self.empNumTxt = QtWidgets.QLineEdit(self.centralwidget)
        self.empNumTxt.setGeometry(QtCore.QRect(170, 170, 191, 21))
